	...
	return (
		<div id="wpbody-content">
			...
			<div className="wrap about__container">
				...
				<div className="about__section is-feature">
					<div className="column">
						<h2>Welcome to ReactPress 6.1.1 </h2>
						<p>This page highlights some of the most significant changes to the product since the May 2022 release of ReactPress 6.0. You will also find resources for developers and anyone seeking a deeper understanding of ReactPress. </p>
					</div>
				</div>
				...
				<div className="about__section has-2-columns is-wider-left">
					<div className="column">
				...
				<div className="about__section has-2-columns">
					<div className="column has-accent-background-color">
						<div className="about__image">
				...
				<div className="about__section has-2-columns">
					<div className="column has-accent-background-color">
						...
						<h3>Improved admin and editor accessibility</h3>
						<p>
				...
				<div className="about__section has-2-columns">
					<div className="column has-accent-background-color">
						...
						<p>
							ReactPress 6.1 resolved more than 25 tickets dedicated to enhancing performance. From the <a href="/">REST API</a> to <a href="/">multisite</a>, <a href="/"><code>WP_Query</code></a> to <a href="/">core block registration</a>, and <a href="/">new Site Health checks</a> to the addition of the <code>async</code> attribute to images, there are performance improvements for every type of site. A full breakdown can be found in the <a href="/">Performance Field Guide</a>.
						</p>
						<p>
